...
- Melanie Taprogge: extension of the LEO-III automated theorem prover for higher-order logic producing Lambdapi proofs [[github]](https://github.com/melanie-taprogge/Leo-III/tree/LPverification) [[2024 MSc thesis]](https://inria.hal.science/hal-04733263)
...
- [Alessio Coltellacci](https://github.com/NotBad4U) and [Stephan Merz](https://members.loria.fr/Stephan.Merz/): extension of the Alethe proof verifier Carcara for SMT solvers producing Lambdapi proofs [[github]](https://github.com/NotBad4U/carcara) [[SMT'24]](https://ceur-ws.org/Vol-3725/paper8.pdf) [[FroCoS'25]](https://doi.org/10.1007/978-3-032-04167-8_20)
- [Geoff Sutcliffe](https://www.cs.miami.edu/home/geoff/): translator from TSTP to Lambdapi [[github]](https://github.com/TPTPWorld/GDV) [[FLAIRS'25]](https://doi.org/10.32473/flairs.38.1.138642)
- [Guillaume Burel](http://web4.ensiie.fr/~guillaume.burel/) and [Frédéric Blanqui](https://blanqui.gitlabpages.inria.fr/): ZenonModulo automated theorem prover for first-order logic producing Lambdapi proofs [[github]](https://github.com/Deducteam/zenon_modulo/)
- Anne Grieu and [Jean-Paul Bodeveix](https://www.irit.fr/~Jean-Paul.Bodeveix/): certification of Event-B proofs generated by Rodin in Lambdapi [[ABZ'24]](https://doi.org/10.1007/978-3-031-63790-2_29) [[ABZ'25]](https://doi.org/10.1007/978-3-031-94533-5_8)
...
- Nicolas Margulies: formalization of cubical type theory in Lambdapi [[github]](https://github.com/nicomarg/CubicalDk)
- Amélie Ledein and Elliot Butte: translation of MetaMath to Lambdapi [[github]](https://gitlab.com/semantiko/mm2dk/translator) [[JFLA'23]](https://inria.hal.science/hal-03936696)
- Amélie Ledein: translation of K to Lambdapi [[github]](https://gitlab.com/semantiko/kamelo) [[JFLA'22]](https://hal.science/hal-03604962) [[TYPES'22]](https://doi.org/10.4230/LIPIcs.TYPES.2022.12)
...
- Luc Chabassier: formalization of some category theory [[github]](https://github.com/dwarfmaster/categories-in-lp) and of extensional type theory [[github]](https://github.com/dwarfmaster/ett-in-lambdapi) [[2025 PhD thesis]](https://theses.hal.science/tel-05229403)
- Gabriel Hondet: translation of PVS statements to Lambdapi [[github]](https://github.com/Deducteam/personoj) [[2022 PhD thesis]](https://inria.hal.science/tel-03855351)
- Quentin Garchery: certification of Why3 proof task transformations in Lambdapi [[PxTP'21]](https://dx.doi.org/10.4204/EPTCS.336.2) [[2022 PhD thesis]](https://inria.hal.science/tel-03560564)
