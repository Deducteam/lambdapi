...
[Dot](https://www.graphviz.org/doc/info/lang.html) language. For more 
information on the graphs, see [`tree_graphviz.ml`](src/core/tree_graphviz.ml).

Note for developers: the ghost symbols can be printed as well, for instance
```
