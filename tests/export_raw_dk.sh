...
do
    ...
    case $f in
        ...
        # proofs
<<<<<<< HEAD
        why3*|tutorial|try|tautologies|rewrite*|remove|natproofs|have|generalize|foo|comment_in_qid|apply|anonymous|admit|change|assumption);;
=======
        why3*|tutorial|try|tautologies|rewrite*|remove|natproofs|have|generalize|foo|comment_in_qid|apply|anonymous|admit|change|assumption|focus|assume);;
>>>>>>> 5a7bf620 (add #print and update #assume term tactics)
        # "open"
