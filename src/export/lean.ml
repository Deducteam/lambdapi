(** Translate parser-level Lambdapi commands to Lean.

There are two modes:

- raw_lean: translation of commands as they are

- stt_lean: translation of commands modulo an encoding of simple type theory
