...
(** Pure wrappers around compilation functions. The provided functions
    perform the same computations as the ones defined above, but restore
    the state when they have finished. An optional library mapping or
